...
-- at runtime using the environment variable peeky_blinders_bindir.
...
-- environment variable peeky_blinders_libdir.
...
-- using the environment variable peeky_blinders_dynlibdir.
...
-- runtime using the environment variable peeky_blinders_datadir.
...
-- variable peeky_blinders_libexedir.
...
-- using the environment variable peeky_blinders_sysconfdir.
...
libdir     = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.12.2-9b33/peeky-blinders-0.1-inplace-test"
dynlibdir  = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.12.2-9b33"
datadir    = "/home/runner/.cabal/share/x86_64-linux-ghc-9.12.2-9b33/peeky-blinders-0.1"
libexecdir = "/home/runner/.cabal/libexec/x86_64-linux-ghc-9.12.2-9b33/peeky-blinders-0.1"
sysconfdir = "/home/runner/.cabal/etc"

getBinDir     = catchIO (getEnv "peeky_blinders_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "peeky_blinders_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "peeky_blinders_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "peeky_blinders_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "peeky_blinders_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "peeky_blinders_sysconfdir") (\_ -> return sysconfdir)
