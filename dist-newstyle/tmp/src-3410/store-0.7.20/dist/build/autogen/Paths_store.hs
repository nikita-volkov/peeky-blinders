...
-- at runtime using the environment variable store_bindir.
...
-- environment variable store_libdir.
...
-- using the environment variable store_dynlibdir.
...
-- runtime using the environment variable store_datadir.
...
-- using the environment variable store_sysconfdir.
...
bindir     = "/home/runner/.local/state/cabal/store/ghc-9.12.2-9b33/store-0.7.20-070c172271223af3478f72e45e379b7147f95bd75fb3d7de1107aee9cdba9f12/bin"
libdir     = "/home/runner/.local/state/cabal/store/ghc-9.12.2-9b33/store-0.7.20-070c172271223af3478f72e45e379b7147f95bd75fb3d7de1107aee9cdba9f12/lib"
dynlibdir  = "/home/runner/.local/state/cabal/store/ghc-9.12.2-9b33/store-0.7.20-070c172271223af3478f72e45e379b7147f95bd75fb3d7de1107aee9cdba9f12/lib"
datadir    = "/home/runner/.local/state/cabal/store/ghc-9.12.2-9b33/store-0.7.20-070c172271223af3478f72e45e379b7147f95bd75fb3d7de1107aee9cdba9f12/share"
libexecdir = "/home/runner/.local/state/cabal/store/ghc-9.12.2-9b33/store-0.7.20-070c172271223af3478f72e45e379b7147f95bd75fb3d7de1107aee9cdba9f12/libexec"
sysconfdir = "/home/runner/.local/state/cabal/store/ghc-9.12.2-9b33/store-0.7.20-070c172271223af3478f72e45e379b7147f95bd75fb3d7de1107aee9cdba9f12/etc"

getBinDir     = catchIO (getEnv "store_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "store_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "store_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "store_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "store_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "store_sysconfdir") (\_ -> return sysconfdir)
